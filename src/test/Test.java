...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			sistema.agregarUnidadVentaParaFestival(sistema.buscarFestivalPorDatos("Cosquín Rock", "Verano 2026", LocalDate.of(2026, 2, 14)), sistema.buscarUnidadVentaPorCodigoUnico("PD00000001"));
			sistema.agregarUnidadVentaParaFestival(sistema.buscarFestivalPorDatos("Cosquín Rock", "Verano 2026", LocalDate.of(2026, 2, 14)), sistema.buscarUnidadVentaPorCodigoUnico("PD00000002"));
			sistema.agregarUnidadVentaParaFestival(sistema.buscarFestivalPorDatos("Cosquín Rock", "Verano 2026", LocalDate.of(2026, 2, 14)), sistema.buscarUnidadVentaPorCodigoUnico("PD00000005"));
			sistema.agregarUnidadVentaParaFestival(sistema.buscarFestivalPorDatos("Food Truck Fest", "Primavera 2026", LocalDate.of(2026, 9, 18)), sistema.buscarUnidadVentaPorCodigoUnico("FT00000001"));
