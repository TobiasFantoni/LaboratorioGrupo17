...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			sistema.agregarUnidadVentaParaFestival(sistema.buscarFestivalPorDatos("Cosquín Rock", "Verano", LocalDate.of(2026, 1, 15)), 
		...
		Festival festival1 = sistema.buscarFestivalPorDatos("Cosquín Rock", "Verano", LocalDate.of(2026, 1, 15));
		...
		try {
			...
			sistema.registrarPedido(festival1, LocalDate.of(2026, 1, 1) , "PD00000001", detallePedido1U1F1);
			sistema.registrarPedido(festival1, LocalDate.of(2026, 1, 5) , "PD00000001", detallePedido2U1F1);
			sistema.registrarPedido(festival1, LocalDate.of(2026, 1, 10) , "PD00000002", detallePedido1U2F1);
			sistema.registrarPedido(festival1, LocalDate.of(2026, 2, 5) , "PD00000002", detallePedido2U2F1);
			sistema.registrarPedido(festival1, LocalDate.of(2026, 2, 10) , "PD00000005", detallePedido1U3F1);
			sistema.registrarPedido(festival1, LocalDate.of(2026, 2, 15) , "PD00000005", detallePedido2U3F1);
			sistema.registrarPedido(festival2, LocalDate.of(2026, 1, 1) , "FT00000001", detallePedido1U1F2);
			sistema.registrarPedido(festival2, LocalDate.of(2026, 1, 1) , "FT00000001", detallePedido2U1F2);
			sistema.registrarPedido(festival2, LocalDate.of(2026, 1, 1) , "FT00000002", detallePedido1U2F2);
			sistema.registrarPedido(festival2, LocalDate.of(2026, 1, 1) , "FT00000002", detallePedido2U2F2);
			sistema.registrarPedido(festival2, LocalDate.of(2026, 1, 1) , "FT00000003", detallePedido1U3F2);
			sistema.registrarPedido(festival2, LocalDate.of(2026, 1, 1) , "FT00000003", detallePedido2U3F2);
